...
const createPlacesController = async (req, res) => {
    ...
    try {
        const result = await places_service_1.PlacesServices.createPlacesService(req.body);
        res.status(201).send({
            success: true,
...
const getPlacesController = async (req, res) => {
    ...
    try {
        const result = await places_service_1.PlacesServices.getPlacesService(start_price, end_price);
        res.status(200).send({
            success: true,
